...
%\date{\today}
\institute{
	$^1$ \includegraphics[width=3.25in]{UVMLogoOutlineWhite}
	$^2$ \includegraphics[width=1in]{complexsystems}
	$^3$ \includegraphics[width=2in]{vcbh}
	$^4$ \includegraphics[width=2in]{oxford_logo}
	$^5$ \includegraphics[width=1.5in]{bath_logo}
}
%%%%%%%%%
